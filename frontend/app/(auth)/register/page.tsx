    ...
    <div className="min-h-screen flex bg-background-dark">
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12 bg-background-dark relative">
        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            <h2 className="text-3xl font-display font-bold text-text-main">Establish Your Ledger</h2>
            <p className="mt-2 text-muted font-body text-sm">Begin your journey to financial clarity.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                minLength={8}
              />
              <p className="text-xs text-muted/70 mt-1">Must be at least 8 characters.</p>
            </div>
